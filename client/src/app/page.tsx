        ...
        prevPosts.map((post) => {
          if (post.id === postId) {
            ...
            return {
              ...post,
              disliked: !newDisliked,
              // we don't rollback the liked state exactly as it was without tracking it, 
              // but the PostCard already handles rollback visually. The next refresh will sync anyway.
            };
          }
          return post;
        })
